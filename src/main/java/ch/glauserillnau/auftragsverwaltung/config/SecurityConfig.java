    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/work-orders/*/dispatch").hasAnyRole("ADMIN", "MANAGER")
                .requestMatchers("/api/work-orders/*/approve-report").hasAnyRole("ADMIN", "MANAGER")
                .requestMatchers("/api/work-orders/*/invoice").hasAnyRole("ADMIN")
